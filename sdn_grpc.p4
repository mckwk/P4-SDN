...
control MyDeparser(packet_out packet, in headers hdr) {
    apply {
        ...
        packet.emit(hdr.myTunnel); // Emit unconditionally; invalid headers won't be emitted
        packet.emit(hdr.ipv4);     // Emit unconditionally; invalid headers won't be emitted
    }
}
